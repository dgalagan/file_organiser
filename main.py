...
def main():
    ...
    try:
        ...
        (
            ...
            .compute(lambda s: s.duplicated(), func_mode="series", store_col="isDuplicate", col_names=["SourceFile"])
            .compute(lambda row: row.min(), func_mode="row", store_col="AggTimestamp", col_keywords=created_dt_tags)
